...
async def test_event_distribution(db_session: AsyncSession, predefined_queue, correlation_id, mock_exchange: MockExchange):
    await main()
    ...
    async with db_session:
        ...
        expected_message = aio_pika.Message(msgpack.packb({
